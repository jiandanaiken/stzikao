...
PageTitle = "正文"
ItemID = ArticleID
strFileName = "Print.asp"
        
sql = "select * from PE_Article where Deleted=" & PE_False & " and Status=3 and ReceiveType=0 and ArticleID=" & ArticleID & " and ChannelID=" & ChannelID & ""
...
Else
    ...
    If SkinID = 0 Then SkinID = DefaultItemSkin
    If IsNull(SkinID) Then SkinID = 0
    ...
    strHtml = GetTemplate(ChannelID, 17, 0)
