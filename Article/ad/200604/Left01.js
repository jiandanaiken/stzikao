...
ZoneAD_3.ZoneID      = 3;
ZoneAD_3.ZoneWidth   = 170;
ZoneAD_3.ZoneHeight  = 146;
ZoneAD_3.ShowType    = 1;
...
objAD.ADType         = 1;
objAD.ADName         = "报考攻略";
objAD.ImgUrl         = "/AD/UploadADPic/200712/20071220120939111.jpg";
objAD.InstallDir     = "/";
objAD.ImgWidth       = 170;
objAD.ImgHeight      = 146;
objAD.FlashWmode     = 0;
objAD.ADIntro        = "";
objAD.LinkUrl        = "http://stzikao.com/bbs/dispbbs.asp?boardID=5&ID=2367&page=1";
objAD.LinkTarget     = 1;
objAD.LinkAlt        = "2008年新生报名、旧生报考攻略";
objAD.Priority       = 1;
objAD.CountView      = 1;
objAD.CountClick     = 1;
objAD.ADDIR          = "AD";
