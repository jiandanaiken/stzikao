    ...
    if(xml.readyState != 4 || root.length == 0){
        ...
        if(loginstat=='err'){
            ...
            if(showtype==0){
               ...
               {
                tempstr += "<table align=\"center\" width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">";
                tempstr += "<tr><td align=\"right\"><font color=\"#000000\">&#x7528;&#x6237;&#x540D;&#xFF1A;</font></td><td><input name=\"UserName\" type=\"text\" id=\"UserName\" size=\"8\" maxlength=\"20\" style=\"width:80px; height:12px;\"></td>";
                tempstr += "<td align=\"right\"><font color=\"#000000\">&#x5BC6;&#x7801;&#xFF1A;</font></td><td><input name=\"UserPassword\" type=\"password\" id=\"Password\" size=\"8\" maxlength=\"20\" style=\"width:80px; height:12px;\"></td>";
                if(root.item(0).getElementsByTagName("checkcode").item(0).text=='1'){
                ...
                tempstr += "</td><td><input name=\"Login\" type=\"image\" id=\"Login\" src=\"" + siteroot + "skin/web/button_login.gif\" value=\"\" onclick=\"CheckUser(" + root.item(0).getElementsByTagName("checkcode").item(0).text + ");\" style=\"width:39px;height:16px;\"></td><td><a href=\"" + siteroot + "Reg/User_Reg.asp\" target=\"_blank\"><font color=\"#000000\">&#x6CE8;&#x518C;</font></a> <a href=\"" + siteroot + "User/User_GetPassword.asp\" target=\"_blank\"><font color=\"#000000\">&#x5FD8;&#x8BB0;&#x5BC6;&#x7801;</font></a></td></tr></table>";
               }
               else{
                tempstr += "<table align=\"center\" width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">";
            ...
            if(showtype==0){
                ...
                tempstr += "</font></b>";
                tempstr += "</div><div id=\"userlogined\">&#x5F85;&#x5BA1;&#xFF1A; <b><font color=\"gray\">" + root.item(0).getElementsByTagName("article").item(0).text + "</font></b> &#x7BC7;";
                if(root.item(0).getElementsByTagName("unreadmessage/stat").item(0).text=='full'){
                    tempstr += "</div><div id=\"usermessage\" class=\"havemessage\" onmouseover=\"havemessage();\" onmouseout=\"hidemessage();\" onclick=\"Element.toggle('messagelist');\" style=\"cursor:hand;\">&#x5F85;&#x9605;&#xFF1A; <b><font color=\"gray\">" + root.item(0).getElementsByTagName("message").item(0).text + "</font></b> &#x6761;";
                    ...
                    tempstr += "</div><div id=\"userlogined\">&#x5F85;&#x9605;&#xFF1A; <b><font color=\"gray\">" + root.item(0).getElementsByTagName("message").item(0).text + "</font></b> &#x6761;";
                }
                tempstr += "</div><div id=\"userlogined\">&#x767B;&#x5F55;&#xFF1A; <b><font color=\"blue\">" + root.item(0).getElementsByTagName("logined").item(0).text + "</font></b> &#x6B21;";
                ...
                if(showtype==3){
                    ...
                    tempstr += "<td>&#x5F85;&#x5BA1;&#xFF1A;<b><font color=\"#ffff00\">" + root.item(0).getElementsByTagName("article").item(0).text + "</font></b> &#x7BC7;</td>";
                    tempstr += "<td>&#x5F85;&#x9605;&#xFF1A;<b><font color=\"#ffff00\">" + root.item(0).getElementsByTagName("message").item(0).text + "</font></b> &#x6761;</td>";
                    tempstr += "<td>&#x767B;&#x5F55;&#xFF1A;<b><font color=\"#ffff00\">" + root.item(0).getElementsByTagName("logined").item(0).text + "</font></b> &#x6B21;</td>";
                    ...
                    tempstr += "<td>&#x5F85;&#x5BA1;&#xFF1A;<b><font color=\"gray\">" + root.item(0).getElementsByTagName("article").item(0).text + "</font></b> &#x7BC7;</td>";
                    tempstr += "<td>&#x5F85;&#x9605;&#xFF1A;<b><font color=\"gray\">" + root.item(0).getElementsByTagName("message").item(0).text + "</font></b> &#x6761;</td>";
                    tempstr += "<td>&#x767B;&#x5F55;&#xFF1A;<b><font color=\"blue\">" + root.item(0).getElementsByTagName("logined").item(0).text + "</font></b> &#x6B21;</td>";
