...
ZoneAD_4.ZoneID      = 4;
ZoneAD_4.ZoneWidth   = 200;
ZoneAD_4.ZoneHeight  = 200;
ZoneAD_4.ShowType    = 1;
...
objAD.ADType         = 1;
objAD.ADName         = "网校";
objAD.ImgUrl         = "/AD/UploadADPic/200611/20061122133317259.gif";
objAD.InstallDir     = "/";
objAD.ImgWidth       = 170;
objAD.ImgHeight      = 60;
objAD.FlashWmode     = 0;
objAD.ADIntro        = "等级考试二级——C语言程序设计&quot;&gt;等级考试二级——C语言程序设";
objAD.LinkUrl        = "http://edu.stzikao.com/";
objAD.LinkTarget     = 1;
objAD.LinkAlt        = "等级考试二级——C语言程序设计&quot;&gt;等级考试二级——C语言程序设";
objAD.Priority       = 1;
objAD.CountView      = 1;
objAD.CountClick     = 0;
objAD.ADDIR          = "AD";
