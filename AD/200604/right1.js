...
ZoneAD_5.ZoneID      = 5;
ZoneAD_5.ZoneWidth   = 200;
ZoneAD_5.ZoneHeight  = 200;
ZoneAD_5.ShowType    = 1;

var objAD = new ObjectAD();
objAD.ADID           = 5;
objAD.ADType         = 1;
objAD.ADName         = "自定义广告位03";
objAD.ImgUrl         = "/skin/mzstory/ad03a.gif";
objAD.InstallDir     = "/";
objAD.ImgWidth       = 170;
objAD.ImgHeight      = 60;
objAD.FlashWmode     = 0;
objAD.ADIntro        = "";
objAD.LinkUrl        = "https://www.zkbooks.com";
objAD.LinkTarget     = 1;
objAD.LinkAlt        = "广东自考书店";
objAD.Priority       = 1;
objAD.CountView      = 1;
objAD.CountClick     = 0;
objAD.ADDIR          = "AD";
